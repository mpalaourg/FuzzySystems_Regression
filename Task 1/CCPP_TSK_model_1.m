...
%% Create the model %%
%~ 2 Features, with Gaussian Membership Functions and Singleton Output ~%
Model = genfis1(D_trn, 2, 'gbellmf','constant'); %
...
sgtitle('Model 1: Membership Functions of Initial Model')
subplot(2,2,1);
...
sgtitle('Model 1: Membership Functions of Trained Model')
subplot(2,2,1);
...
%~ Learning Curves ~%
figure('Name','Training and Checking Error for 2 Features','NumberTitle','off')
sgtitle(' Learning Curve of Model 1' )
...
sgtitle('Model 1: Prediction Error' )
subplot(1,2,1)

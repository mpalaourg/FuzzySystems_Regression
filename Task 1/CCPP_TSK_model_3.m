...
%% Create the model %%
%~ 2 Features, with Gaussian Membership Functions and Polynomial Output ~%
Model = genfis1(D_trn, 2, 'gbellmf','linear');
...
sgtitle('Model 3: Membership Functions of Initial Model')
subplot(2,2,1);
...
sgtitle('Model 3: Membership Functions of Trained Model')
subplot(2,2,1);
...
sgtitle('Learning Curve of Model 3' )
...
sgtitle('Model 3: Prediction Error' )
subplot(1,2,1)
